...
const TEXTOS = {
  ...
  "esfuerzo": "Cuántas veces intenta acomodar antes de quedarse con la mejor. Más esfuerzo nunca da un resultado peor, pero tarda más. Arranca en Rápido: si el acomodo te deja lugar de sobra, subilo a Normal.",
